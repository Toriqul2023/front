    ...
    <div className='bg-[#0B0D0E]'>
       <div className="container mx-auto py-4 ">
        <div className="row grid lg:grid-cols-4 gap-3 justify-center">
          <div className='p-5'>
          <div className="my-4 radial-progress" name='progress-1' style={{ "--value": "70", "--size": "10rem", "--thickness": "10px","color":"#08D665" }} role="progressbar"><span className='text-4xl text-white'>70%</span></div>
          </div>
          <div>
          <div className="my-4 radial-progress" name='progress-1' style={{ "--value": "65", "--size": "10rem", "--thickness": "10px","color":"#08D665" }} role="progressbar">
            <span className='text-4xl text-white'>65%</span></div>
          </div>
          <div>
          <div className="my-4 radial-progress" name='progress-1' style={{ "--value": "80", "--size": "10rem", "--thickness": "10px","color":"#08D665" }} role="progressbar">
            <span className='text-4xl text-white'>80%</span></div>
          </div>
          <div>
          <div className="my-4 radial-progress" name='progress-1' style={{ "--value": "60", "--size": "10rem", "--thickness": "10px","color":"#08D665" }} role="progressbar">
