...
const Navbar = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[999] text-black p-2 shadow bg-base-100 rounded-box w-52">
        
        <li>
          <Link href='https://www.facebook.com/mohammad.toriqul.toriq'>Parent</Link>
          <ul className="p-2">
            <li><Link href='https://www.facebook.com/mohammad.toriqul.toriq'>Submenu 1</Link></li>
            <li><Link href='https://www.facebook.com/mohammad.toriqul.toriq'>Submenu 2</Link></li>
